...
public class Transaction {
    ...
    public Transaction(Long id, Double amount, String transactionType, LocalDate transactionDate, EPaymentStatus transactionStatus, CreditCardDetails creditCard) {
        this.id = id;
        this.amount = amount;
        this.transactionType = transactionType;
        this.transactionDate = transactionDate;
